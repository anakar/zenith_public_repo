...
include_once('class/class_lookups.php');

if($_POST['subShowValues']!=''){ $_REQUEST[pgn] = 1; }

# Create object
$thisObj = new Lookups; //VVIP Line
#================================================================================
?>
<!DOCTYPE html>
<html>
		...
		<table width="100%" cellpadding="3" cellspacing="2" border="0">
			...
			if($_REQUEST['Lookup_Field_Id']!=''){
				switch($thisObj->doAct){
					case "insert":
						if($_POST['subAdd']!=''){
							if($thisObj->insertRecord()){ $_SESSION['doAct_sucMsg'] = 'The value has been successfully added.'; $thisObj->redirectTo($thisObj->thisFile); }
						}//if
					case "add":
					...
					case "update":
						if($_POST['subUpdate']!=''){
							if($thisObj->insertRecord()){ $_SESSION['doAct_sucMsg'] = 'The value has been successfully updated.'; }
						}//if
					case "edit":
					...
					break;
					case "delete":
						if($thisObj->deleteRecord()){ $_SESSION['doAct_sucMsg'] = 'The value has been successfully inactivated.'; $thisObj->redirectTo($thisObj->thisFile); }
					default:
